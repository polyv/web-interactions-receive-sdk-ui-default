<template>
  <div v-if="question" class="plv-iar-questionnaire-question-mobile">
    <div>
      <p
        ...
        >
          <div class="plv-iar-questionnaire-question__option__inner-wrap">
            ...
            <label v-if="question.type === 'R'">
              ...
              <div class="plv-iar-questionnaire-question__option__mobile--border pws-vclass-questionnaire-question__option__mobile--border"></div>
            </label>
            ...
            <label v-else-if="question.type === 'C'">
              <input
                v-model="values"
                type="checkbox"
                class="plv-iar-questionnaire-question__option__input plv-iar-questionnaire-question__option__input--multi pws-vclass-questionnaire-question__option__input--single"
                :name="question.questionId"
                :value="optionChar(optionIndex)"
              />
              <span class="plv-iar-questionnaire-question__option__dot"></span>
...
.plv-iar-questionnaire-question-mobile {
  ...
  .plv-iar-questionnaire-question__option {
    label {
      ...
      .plv-iar-questionnaire-question__option__mobile--border {
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
...
.plv-iar-questionnaire-question__option__circle--active {
  border-color: #3082FE;
  color: #3082FE;
  background-color: rgba(#3082FE, .1);
}
.plv-iar-questionnaire-question__title--required {
  position: absolute;
  top: 0;
  left: 0;
  font-size: 12px;
