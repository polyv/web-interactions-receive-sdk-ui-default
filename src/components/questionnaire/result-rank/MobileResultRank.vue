<template>
  <div class="plv-iar-result-rank">
    ...
    <div class="plv-iar-result-rank__content">
      <v-table :columns="columns" :data-list="bottomResults" :tbody-height="'300px'">
        <template #costTime="{slotData}">
          <div class="plv-iar-result-rank__content__name">
            ...
            <div class="plv-iar-result-rank__content__other-info">
              <span class="plv-iar-result-rank__content__nickname">{{ slotData.nickname }}</span>
  ...
  computed: {
    columns() {
      return [
        ...
        {
          label: `${this.iarTrans('questionnaire.nicknameLabel')} / ${this.iarTrans('questionnaire.costTimeLabel')}`,
          props: 'costTime',
          slotName: 'costTime'
        },
        {
...
.plv-iar-result-rank__top-content {
  ...
  .plv-iar-result-rank__top-item {
    ...
    align-items: center;
    width: 110px;
    background-image: url('./imgs/mobile-top-rank-base.svg');
...
.plv-iar-result-rank__content, .plv-iar-result-rank__footer {
  .plv-iar-result-rank__content__name {
    ...
    align-items: center;
    line-height: 19px;
    .plv-iar-result-rank__content__nickname {
      white-space: nowrap;
      overflow: hidden;
      text-overflow: ellipsis;
      text-align: left;
    ...
    .plv-iar-result-rank__content__other-info {
      display: flex;
      flex-direction: column;
