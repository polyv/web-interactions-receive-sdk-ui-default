<template>
  <modal class="plv-iar-welfare-lottery__modal--answer-question plv-iar-welfare-lottery__modal--normal">
    ...
    <!-- 展示统计-->
    <div v-else-if="isShowStatistics" class="plv-iar-welfare-lottery__modal-contain">
...
import Modal from '../../common/modal/PcModal.vue';
...
.plv-iar-welfare-lottery__modal--answer-question {
  .plv-iar-modal__main {
    ...
    .plv-iar-questionnaire-question__option label .plv-iar-questionnaire-question__option__mobile--border {
      border: 1px solid rgb(255 178 153 / 30%);
    }

    .plv-iar-questionnaire-question__option label .plv-iar-questionnaire-question__option__input:checked ~ .plv-iar-questionnaire-question__option__mobile--border {
      border-color: #FFA515;
    }

    .plv-iar-questionnaire-question__option label .plv-iar-questionnaire-question__option__input:checked ~ .plv-iar-questionnaire-question__option__text {
      color: #FFA515;
    }
  }
