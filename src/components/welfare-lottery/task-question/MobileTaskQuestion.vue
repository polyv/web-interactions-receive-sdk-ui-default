<template>
  <div>
    <modal-gift-box
      ...
      class="plv-iar-welfare-lottery__task__wrap plv-iar-welfare-lottery__task__wrap--mobile plv-iar-welfare-lottery__task__question"
    ...
    >
      ...
      <template #body>
        ...
        >
          <template #header>
            <div class="plv-iar-welfare-lottery__task__prize-tabs">
              <div
...
import ModalAnswerQuestion from '../modal-answer-question/MobileModalAnswerQuestion';
...
@media screen and (min-aspect-ratio: 4/3) {
  .plv-iar-welfare-lottery__task__question {
    .plv-iar-modal__main {
      background-image: url(../imgs/modal-lottery-question-bg--fullscreen.png) !important;
    }
  }
}
