...
<template>
  <div class="plv-demo-welfare-lottery">
    <!-- 条件抽奖组件内容 -->
    <welfare-lottery
      :lang="lang"
      :watch-url="watchUrl"
...
<script>
import WelfareLotteryComp from '../../entry/welfare-lottery/MobileWelfareLottery.vue';
import mixin from './mixin';

export default {
  components: {
    'welfare-lottery': WelfareLotteryComp,
  },
  mixins: [mixin],
};
</script>
<style lang="scss">
.plv-demo-welfare-lottery {
  position: absolute;
  top: 20px;
  right: 20px;
  background-color: #202127;
  .plv-iar-conditional-draw__entrance {
    margin: 0 auto;
  }
}
</style>
